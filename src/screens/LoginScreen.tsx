...
interface Props {
  onNavigate: (screen: 'WELCOME' | 'REGISTER') => void;
}
    ...
    <View style={{ flex: 1, backgroundColor: COLORS.backgroundDark }}>
      ...
      <View style={styles.formContainer}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.subtitle}>Login to continue your productivity</Text>
          ...
          <TouchableOpacity style={styles.btnPrimaryFull} onPress={handleLogin} disabled={loading}>
            {loading ? <ActivityIndicator color="white" /> : <Text style={styles.textWhiteBold}>LOGIN</Text>}
          </TouchableOpacity>

          <View style={styles.switchLine}>
            <Text style={{color: COLORS.textLight}}>Belum punya akun? </Text>
